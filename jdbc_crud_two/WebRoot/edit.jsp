...
<body>
	<h1>修改页面</h1>
	<form action="servletfriends?do=edit" method="post">
		<fieldset>
			<legend>Legends Never Die</legend>
			<label>姓名 <input type="text"  placeholder="name"  name="name">
			</label> 
			<label>年龄 <input type="text"  placeholder="age" name="age">
			</label>
			<label>电话<input type="text"  placeholder="phonenum" name="phonenum">
			</label>
			<label>生日<input type="date"  placeholder="date" name="date">
			</label>
			<label>爱好<input type="text"  placeholder="favorite" name="favorite">
			</label>
